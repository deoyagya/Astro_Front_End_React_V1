...
const TYPE_ICONS = {
  ...
  question_router_producer_system: 'fa-diagram-project',
  question_router_reviewer_system: 'fa-user-check',
  question_router_producer_user: 'fa-route',
  question_router_reviewer_user: 'fa-list-check',
